...
proj_start=1600 # 2333 center for circle @ 0 1212 center, 615@0                    center  @ skew_angle_mtx=[-0.0566] 
...
center_of_rotation_px_matx=[1264-300] # @3200 Mememoma #pass 2 may 2024
...
skew_angle_mtx=[0.32] #Local second best guess. 
...
def parallel_sectional_write_plusprocessing_listdist(in_list):
    ...
    # Start modification
    if read_h5:
        incoming_gain_pre=h5py.File(gain_path, 'r')['exchange/data']
        incoming_dark_pre=h5py.File(dark_path, 'r')['exchange/data']
        incoming_gain_post=h5py.File(gain_path_post, 'r')['exchange/data']
        incoming_dark_post=h5py.File(dark_path_post, 'r')['exchange/data']
